...
class ResPartner(models.Model):
    ...
    def action_update_customer_bigcommerce(self):
        ...
        payload = [{
            ...
            # BigCommerce docs say "phone" singular, but sometimes "phones" array? Use "phone"
            "phone": self.phone or "",
            ...
            # "origin_channel_id": self.bigcommerce_origin_channel_id, # read-only, do not update
        }]
    ...
    def action_create_bigcommerce_customer_address(self):
        ...
        if response.status_code in [200, 201]:
            ...
            print('data : ',data)
            # if data:
            #     # Optionally handle the returned address data here
            #     # For example, save BigCommerce address ID or other info on Odoo model if you want
            #     address_info = data[0]
            #     self.bigcommerce_address_id = address_info.get('id', False)
    ...
    def action_update_bigcommerce_address(self):
        ...
        # if not self.bigcommerce_address_id:
        #     raise UserError("No BigCommerce Address ID set on this record.")
        ...
        # Ensure this address is linked to a customer
        # if not self.parent_id or not self.parent_id.bigcommerce_customer_id:
