...
class ProductTemplate(models.Model):
    ...
    def export_bigcommerce_product_images(self):
        ...
        #     if image.image_1920:
        #         img_binary = base64.b64decode(image.image_1920)
        #         files = {
        #             'image_file': (image.name or 'extra.jpg', img_binary, 'image/jpeg'),
        #         }
        #
        #         response = requests.post(url, headers=headers, files=files)
        #         if response.status_code != 201:
        #             raise UserError(f"Failed to upload gallery image: {response.text}")
    ...
    def export_bigcommerce_variant(self, product_id, variant):
        ...
        payload = {
            ...
            # Add weight, dimensions, etc. if needed
        }
