...
class ResCurrency(models.Model):
    ...
    bc_token_location = fields.Selection(
        [("left", "Left"), ("right", "Right")], string="Token Location"
    )
    ...
    def action_create_in_bigcommerce(self):
        ...
        if response.status_code != 201:
            raise UserError(
                _("Failed to create currency in BigCommerce: %s") % response.text
            )
        ...
        self.write(
            {
                ...
                "bc_default_for_country_codes": ",".join(
                    bc_currency.get("default_for_country_codes", [])
                ),
        ...
        return {
            ...
            "params": {
                ...
                "type": "success",
                "message": _("Currency '%s' successfully created in BigCommerce.")
                % self.bc_currency_code,
                "sticky": False,
            },
        }
    ...
    def action_get_bigcommerce_currency(self):
        ...
        self.write(
            {
                ...
                "bc_default_for_country_codes": ",".join(
                    currency_data.get("default_for_country_codes", [])
                ),
        ...
        return {
            ...
            "params": {
                ...
                "message": _(
                    "Currency data was successfully fetched from BigCommerce."
                ),
                "sticky": False,
            },
        }
