...
export class ksGanttRenderer extends Component{
    ...
    setup(){
       ...
       console.log('this.props.model.metaData : ',this.props.model.metaData)
...
//       Added grid button.
    ...
    ks_handle_task_side_content() {
      console.log('ks_handle_task_side_content.....')
      function ksRenderDiv(task, date, className) {
        console.log('ksRenderDiv...')
...
//          els.appendChild(task_duration_el);
     ...
     */
    ks_parse_gantt_data() {
      console.log('ks_parse_gantt_data.............')
      var ks_render_data = {};
      var ks_data = [];
      var ks_links = [];
        ...
        this.props.model.ksDataForGantt.records.forEach(
          function (each_task) {
            ...
            if (each_task.ks_project_task_json) {
              console.log('ks_parse_gantt_data right >>>>>>>')
...
//       Check if parent task is available then set add parent otherwise set to false.
    ...
    ks_project_task_data_update(
      ...
      var ks_gantt_datas = {
        ...
        planned_hours: each_project_task.planned_hours,
