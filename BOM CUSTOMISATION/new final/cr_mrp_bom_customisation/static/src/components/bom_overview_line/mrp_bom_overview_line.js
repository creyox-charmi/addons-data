...
//        const explodedQuantity = this.cr_qty;
//        console.log('>>>>>>this.cr_qty : ',this.cr_qty)
//        console.log('event : ',event)
//        console.log('event.target : ',event.target)
//        console.log('event.target.quantity : ',event.target.quantity)
//
//
//        if (bomLineId && rootBomId) {
//            // Save CFE quantity in context
//            await this.ormService.call("mrp.bom.context", "set_context_data", [
//                rootBomId, bomLineId, productId, 'cfe_quantity', newValue
//            ]);
//            console.log('explodedQuantity : ',explodedQuantity)
//            // Also store exploded quantity for PO creation
//            await this.ormService.call("mrp.bom.context", "set_context_data", [
//                rootBomId, bomLineId, productId, 'exploded_quantity', explodedQuantity.toString()
//            ]);
//
...
//                    } else {
//                        this.notification.add("Vendor PO not created", { type: "warning" });
//                    }
//                }
//            }
//
