...
class ProductTemplate(models.Model):
    ...
    def import_bigcommerce_variants(self):
        ...
        for variant in bigcommerce_variants:
            ...
            _logger.info(
                "Matching BigCommerce variant options: %s", variant_option_names
            )
            ...
            if matched_variant:
                ...
                _logger.info(
                    "Matched and updated variant SKU: %s (variant ID: %s)",
                    variant.get("sku"),
                    variant.get("id"),
                )
            else:
                _logger.warning(
                    "No matching variant found in Odoo for BigCommerce SKU: %s",
                    variant.get("sku"),
                )
