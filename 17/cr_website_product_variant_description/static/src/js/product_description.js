...
VariantMixin.onChangeVariant = function (ev) {
    ...
    const _getCombinationInfoForDescription = (ev) => {
        console.log('_getCombinationInfoForDescription called');
        ...
        if ($parent.hasClass('main_product')) {
            ...
            for (const optionalProduct of $optProducts) {
                ...
                jsonrpc('/cr_website_product_variant_description/cr_des', {
                    ...
                    $('#cr_product_description').html(updatedDescription); // Update DOM with the new description
                })
            }
        } else {
