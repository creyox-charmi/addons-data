...
class ProductTemplate(models.Model):
    ...
    def _search_get_detail(self, website, order, options):
        ...
        ref.clear()
        print("BBBBBBBBBBBBB")
        # cr_name = self.env.user.company_id.cr_name
        # internal_reference = self.env.user.company_id.internal_reference
        # description = self.env.user.company_id.description
        # website_description = self.env.user.company_id.website_description
        # tags = self.env.user.company_id.tags
        # attributes = self.env.user.company_id.attributes
        # fields = {
        #     "name": self.env.user.company_id.cr_name,
        #     "default_code": self.env.user.company_id.internal_reference,
        #     "description": self.env.user.company_id.description,
        #     "description_sale": self.env.user.company_id.website_description,
        #     "product_tag_ids": self.env.user.company_id.tags,
        #     "product_variant_ids": self.env.user.company_id.attributes,
        # }
