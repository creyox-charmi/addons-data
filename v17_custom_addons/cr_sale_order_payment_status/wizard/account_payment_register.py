...
class AccountPaymentRegister(models.TransientModel):
    ...
    def action_create_payments(self):
        """Method to create payments and update related sale orders"""
        ...
        # Loop through account moves again to update related sale orders
        for move in ac_move:
            ...
            if count == 0:
                sale.payment_state = 'fully_paid'
            else:
                sale.payment_state = 'partially_paid'

            if is_overdue != 0:
                sale.payment_state = 'overdue'
