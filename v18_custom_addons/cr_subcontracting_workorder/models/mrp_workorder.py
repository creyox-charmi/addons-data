...
class workOrder(models.Model):
    ...
    def button_start_subcontract(self):
        self.subcontract_purchase()
        self.subcontract_delivery()
            ...
            po_line_lst.append(
                (
                    ...
                    0,
                    {
                        ...
                        "name": order.operation_id.service_product_id.name,
                ...
                delivery_line_lst.append(
                    (
                        ...
                        0,
                        {
                            ...
                            "name": order.production_id.product_id.name,
